...
// Get maxRounds from query params on init to ensure child components get value immediately
...
const loadGraph = async (graphId) => {
  // When simulating, auto-refresh doesn't show full-screen loading to avoid flicker
...
onMounted(() => {
  ...
  // Log maxRounds config (value obtained from query params on init)
  if (maxRounds.value) {
