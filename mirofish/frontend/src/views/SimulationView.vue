 ...
 * When user returns from Step 3 to Step 2, default assumption is user wants to exit simulation
 */
const checkAndStopRunningSimulation = async () => {
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      // Environment not running, but process might be active, check simulation status
