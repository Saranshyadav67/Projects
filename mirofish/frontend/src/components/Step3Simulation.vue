  ...
  <div class="simulation-panel">
    ...
    <div class="control-bar">
      <div class="status-group">
        ...
        <!-- Binds CSS classes dynamically based on running state and completion status -->
        <div class="platform-status twitter" :class="{ active: runStatus.twitter_running, completed: runStatus.twitter_completed }">
          <div class="platform-header">
            ...
            <!-- Checkmark badge shown only when the simulation for this platform is done -->
          ...
          <div class="platform-stats">
            <span class="stat">
              ...
              <!-- Displays current round vs total rounds -->
              <span class="stat-value mono">{{ runStatus.twitter_current_round || 0 }}<span class="stat-total">/{{ runStatus.total_rounds || maxRounds || '-' }}</span></span>
            </span>
            <span class="stat">
              <span class="stat-label">Elapsed Time</span>
              <!-- Calculated simulated time based on rounds and minutes per round -->
          ...
          <!-- Tooltip appears on hover to inform the user of possible agent actions -->
        ...
        <!-- Similar structure to Twitter, tracks Reddit-specific metrics -->
    ...
    <div class="main-content-area" ref="scrollContainer">
      ...
      <div class="timeline-feed">
        ...
        <TransitionGroup name="timeline-item">
          <!-- Loops through actions sorted chronologically -->
          <div 
            ...
            <div class="timeline-card">
              <div class="card-header">
                <div class="agent-info">
                  <!-- Avatar uses the first letter of the agent name -->
              ...
              <div class="card-body">
                ...
                <template v-if="action.action_type === 'QUOTE_POST'">
                  ...
                  <!-- Displays the original post being quoted -->
                ...
                <!-- Fallback: Unknown type or content not handled above -->
...
// Reset all states (used for restarting simulation)
const resetAllState = () => {
  phase.value = 0
  runStatus.value = {}
  allActions.value = []
...
const doStartSimulation = async () => {
  ...
  // Reset all states first to ensure no interference from previous simulation
  resetAllState()
...
// Track the last round of each platform to detect changes and output logs
...
const fetchRunStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Detect round changes for each platform separately and output logs
      ...
      // Judge by detecting twitter_completed and reddit_completed status
      const platformsCompleted = checkPlatformsCompleted(data)
      
      if (isCompleted || platformsCompleted) {
        if (platformsCompleted && !isCompleted) {
          addLog('✓ Detected all platform simulations ended')
        }
...
const fetchRunStatusDetail = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      // Use all_actions to get the full list of actions
      ...
      // Do not auto-scroll, let user view timeline freely
