...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - "reddit": Interview only on Reddit platform  
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                - "twitter": Default interview only on Twitter platform
                - "reddit": Default interview only on Reddit platform
                - None: Each Agent is interviewed on both platforms in dual-platform simulation
            timeout: Timeout duration
    ...
    def check_env_alive(self) -> bool:
        ...
        Determines by checking the env_status.json file
        """
