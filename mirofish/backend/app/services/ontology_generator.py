...
- Specific group representatives (such as alumni associations, fan clubs, rights defense groups, etc.)
...
- Various characters will appear in the text, such as "primary/secondary school teachers", "passerby A", "a certain netizen"
- If there is no specific type match, they should be classified into `Person`
...
class OntologyGenerator:
    ...
    def _build_user_message(
        ...
        if len(combined_text) > self.MAX_TEXT_LENGTH_FOR_LLM:
            ...
            combined_text += f"\n\n...(Original text total {original_length} characters, truncated to first {self.MAX_TEXT_LENGTH_FOR_LLM} characters for ontology analysis)..."
...
4. All entity types must be subjects that can speak in reality, cannot be abstract concepts
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Zep API limits: Maximum 10 custom entity types, maximum 10 custom edge types
        MAX_ENTITY_TYPES = 10
        MAX_EDGE_TYPES = 10
