...
Reads nodes from the Zep graph and filters for nodes that match predefined entity types
"""
...
class EntityNode:
    ...
    def get_entity_type(self) -> Optional[str]:
        """Get entity type (excluding default Entity tag)"""
...
class ZepEntityReader:
    ...
    2. Filter for nodes that match predefined entity types (nodes where Labels are not just Entity)
    ...
    def _call_with_retry(
        ...
        Args:
            ...
            max_retries: Maximum retry count (default 3, i.e., maximum 3 attempts)
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            edges = self._call_with_retry(
                ...
                operation_name=f"fetching node edges (node={node_uuid[:8]}...)"
            )
    ...
    def filter_defined_entities(
        ...
        """
        Filter for nodes that match predefined entity types
        
        Filtering logic:
        - If a node's Labels only have "Entity", it means this entity does not match our predefined types, skip
        - If a node's Labels contain tags other than "Entity" and "Node", it matches predefined types, keep
    ...
    def get_entity_with_context(
        ...
        try:
            ...
            node = self._call_with_retry(
                ...
                operation_name=f"fetching node details (uuid={entity_uuid[:8]}...)"
            )
