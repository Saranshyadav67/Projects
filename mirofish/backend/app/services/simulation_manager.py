...
class SimulationState:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "profiles_count": self.profiless_count,
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Args:
            ...
            simulation_requirement: Simulation requirement description (for LLM to generate configuration)
            document_text: Original document content (for LLM to understand background)
            ...
            parallel_profile_count: Number of parallel profile generation, default 3
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No entities found matching criteria, please check if the graph is built correctly"
                self._save_simulation_state(state)
                return state
            ...
            # Set real-time save file path (prioritize Reddit JSON format)
            ...
            # Reddit was already saved in real-time during generation, here we save again to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            # Note: Run scripts remain in the backend/scripts/ directory, no longer copied to simulation directory
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                ...
                f"   - Run Twitter standalone: python {scripts_dir}/run_twitter_simulation.py --config {config_path}\n"
                f"   - Run Reddit standalone: python {scripts_dir}/run_reddit_simulation.py --config {config_path}\n"
