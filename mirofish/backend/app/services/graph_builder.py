...
class GraphBuilderService:
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        # This is required usage by the Zep SDK, warnings come from dynamic class creation and can be safely ignored
    ...
    def _wait_for_episodes(
        ...
        """Wait for all episodes to finish processing (by querying processed status of each episode)"""
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing nodes and edges, including detailed data such as time info, attributes, etc.
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)

        # Create node map to retrieve node names
        node_map = {}
        for node in nodes:
