...
def get_generate_status():
    ...
    try:
        ...
        # If simulation_id provided, check for existing completed report first
        if simulation_id:
            existing_report = ReportManager.get_report_by_simulation(simulation_id)
            if existing_report and existing_report.status == ReportStatus.COMPLETED:
                return jsonify({
...
def get_report_sections(report_id: str):
    ...
    Frontend can poll this endpoint to get generated section content without waiting for the full report to complete.
...
def check_report_status(simulation_id: str):
    ...
    try:
        ...
        # Interview is only unlocked after report completion
...
def get_agent_log(report_id: str):
    ...
    Real-time acquisition of every action during report generation, including:
...
def get_console_log(report_id: str):
    ...
    Real-time acquisition of console output (INFO, WARNING, etc.) during report generation.
