...
Used to persist project state on the server side, avoiding the need for the frontend to pass large amounts of data between interfaces
"""
...
class ProjectManager:
    ...
    def get_project(cls, project_id: str) -> Optional[Project]:
        ...
        Returns:
            Project object, returns None if it doesn't exist
        """
